...
- Offers an optional, disabled-by-default helmet house rule that uses configured equipment in D35E's native `Head` slot to cap inherited Head/Eye/Ear local armor and optionally apply Spot/Listen penalties.
