import { RAW_ARMOR_PIECE_CATALOG, RAW_ARMOR_SUIT_CATALOG } from "../scripts/armor.js";

const MODULE_ID = "d35e-piecemeal-armor-called-shots";
const CORE_VERSION = "14.363";
const SYSTEM_VERSION = "3.0.2";

const PACK_SUIT_LABELS = Object.freeze({
  padded: "Padded",
  leather: "Leather",
...
function pieceDescription(name, piece, categoryLabel) {
  return [
      ...
      flags: {
        [MODULE_ID]: {
          piecemeal: {
            ...
            displaySuitLabel: spec.suitLabel,
