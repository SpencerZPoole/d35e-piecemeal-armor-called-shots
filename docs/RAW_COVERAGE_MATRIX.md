...
| Helmet head coverage | Optional house rule | Disabled by default. Configured D35E `Head` slot helmets can supply their own local Head/Eye/Ear armor only; they do not change total AC or RAW piecemeal suit math. |
