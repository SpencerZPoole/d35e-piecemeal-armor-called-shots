...
| Helmet skill penalties | Optional house rule | Disabled by default. Configured D35E `Head` slot helmets can add table-defined Spot/Listen penalties to D35E skill rolls; helmets do not supply local armor AC. |
